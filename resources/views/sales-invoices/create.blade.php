...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-0">Create Sales Invoice</h4>
        <p class="text-muted small mb-0">Generate a new sales invoice</p>
    </div>
...
<x-card>
    <form method="POST" action="{{ route('sales-invoices.store') }}" id="invoiceForm">
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <x-select name="customer_id" label="Customer" required :options="[]" placeholder="Select Customer" />
            </div>
            <div class="col-md-4">
